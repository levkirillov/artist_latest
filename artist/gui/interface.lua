...
return function(context, extract_items)
  ...
  local checkbox = gui.Checkbox {
    x = 45, y = 2, width = width, label ='Inv',
    on_change = function(value) context.mediator:publish("interface.inv_mode_update", value) end,
  },
  context.mediator:subscribe("interface.inv_mode_set", function(value) checkbox:set_checked(value) end)
